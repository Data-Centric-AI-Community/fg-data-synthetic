...
from data_synthetic.streamlit_app.pages.functions.train import DataType
from data_synthetic.streamlit_app.pages.functions.generate import load_model, generate_profile
