...
from data_synthetic.synthesizers.timeseries.timegan.model import TimeGAN
from data_synthetic.synthesizers.timeseries.doppelganger.model import DoppelGANger
